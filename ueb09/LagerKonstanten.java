public class LagerKonstanten {

    public static final String ERROR_LAGER_IST_LEER                         =  "Behl konnte nicht ausgeführt werden, denn das Lager ist leer.";
    public static final String ERROR_ZU_ENTFERNENDER_ARTIKEL_NICHT_IM_LAGER =  "Nur Artikel im Lager koennen entfernt werden.";
