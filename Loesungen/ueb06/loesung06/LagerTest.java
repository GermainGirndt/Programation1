...
public class LagerTest {
	...
	public void setUp() {
		...
		lagerMitArtikel.legeAnArtikel(new Artikel(1111, "Apfel", 100, 100.10));
		lagerMitArtikel.legeAnArtikel(new Artikel(2222, "Birne", 50, 100.0));
		lagerMitArtikel.legeAnArtikel(new Artikel(3333, "Melone", 55, 55.55));
		
		vollesLager = new Lager(2);
		vollesLager.legeAnArtikel(new Artikel(1111, "Apfel", 100, 99.99));
	...
	public void test_legeArtikelAn_anzahlArtikel_sollte_4_sein() {
		...
		lagerMitArtikel.legeAnArtikel(new Artikel(4444, "Kirsche", 33, 33.33));
	...
	public void test_legeArtikelAn_lager_ist_voll_exception_erwartet() {
		vollesLager.legeAnArtikel(new Artikel(3333, "Melone", 22, 22.22));
	}
